...
/// is an issue anyone can look up. This renders `TaskRow`, and ONLY
/// `TaskRow`.
///
/// AN EARLIER EDIT POINTED THIS AT `PortDiscovery.Listener.portText` and
/// said "this is the test for it". It is not: no listener row has ever
/// been rendered here. That comment advertised coverage that did not
/// exist, which is the exact failure the paragraph below was written to
/// prevent ([[WI-2026-09-07-010]]).
///
