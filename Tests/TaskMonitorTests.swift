...
final class TaskMonitorTests: XCTestCase {
    ...
    func testFilterActivityNoise() {
        let items = [
            activity(agent: TaskMonitor.tempAgentPrefix + "123", tool: "activity.list"),
            activity(agent: TaskMonitor.tempAgentPrefix + "123", tool: "task.list"),
            activity(agent: TaskMonitor.tempAgentPrefix + "123", tool: "task.claim"), // real agent action
