...
final class SynaptySettingsTests: XCTestCase {
    ...
    func testReloadFromDiskDoesNotWriteBackOrChangeTheFile() throws {
        ...
        let delivered = Data(#"{"fontSize":11,"lightThemeName":"Solarized","scrollbackLimit":9000}"#.utf8)
    ...
    func testGhosttyFragmentContent() throws {
        ...
        // The scrollback bound is always present — and asked of the
        // constant the fragment writes, rather than a fourth spelling of
        // it ([[WI-2026-09-11-012]]).
        XCTAssertTrue(fragment.contains(
            "scrollback-limit-lines = \(SynaptySettings.defaultScrollbackLines)"))
