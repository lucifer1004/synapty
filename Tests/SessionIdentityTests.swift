...
final class RemoteIdentityTests: XCTestCase {
    ...
    func testAReattachingPaneCarriesBothNames() {
        ...
        // AN OPTION NOW, NOT A VARIABLE. It rode the environment only
        // because the positional list ended in a variadic run and left no
        // room after it ([[ADR-0020]]).
        XCTAssertTrue(launch.command.contains("--fresh-id "),
