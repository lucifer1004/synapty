...
private struct WorkspaceControls: View {
    ...
    /// THE MANAGER'S ANSWER, not a second copy of the same expression.
    /// `WorkspaceManager.slotCount` is identical and ships
    /// ([[WI-2026-09-11-012]]).
    private var slotCount: Int { paneManager.slotCount }
