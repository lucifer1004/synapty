...
enum AppLog {
    ...
    /// Manifest compilation ([[RFC-0004]] C-PASSIVE-DETECTION). A rule
    /// this build cannot use is dropped, and until [[WI-2026-09-11-014]]
    /// it was dropped in silence — so a manifest compiled with fewer
    /// rules than it has and nothing anywhere said so.
    static let detect = Logger(subsystem: "com.synapty.app", category: "Detect")
}
