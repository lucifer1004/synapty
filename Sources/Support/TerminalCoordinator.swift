...
protocol TerminalCoordinator: AnyObject {
    ...
    /// The pane's own process exited, with the code libghostty was given.
    /// Taken here so that libghostty does not write its own sentence about
    /// it ([[WI-2026-09-07-004]]).
    func leafChildExited(_ leafID: UUID, code: UInt32)
