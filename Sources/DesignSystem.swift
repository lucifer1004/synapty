...
enum DS {
    ...
    enum Layout {
        /// THE NARROWEST A SHEET HOLDING A FORM MAY BE.
        ///
        /// SCALED, LIKE EVERY OTHER FLOOR HERE. Three sheets carried a raw
        /// `320` while every comparable panel used `DS.scaled(...)` and so
        /// does the window floor — so at Extra Large those three alone did
        /// not widen with their content ([[WI-2026-09-11-012]]).
        static var sheetMinWidth: CGFloat { DS.scaled(320) }
